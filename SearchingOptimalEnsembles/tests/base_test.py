def test_evaluate_ensembles(metadataset):
    ...
    pipeline_hps, metric, metric_per_pipeline, time_per_pipeline = metadataset.evaluate_ensembles([[0, 1, 2], [3, 4, 5]])
    ...
    pipeline_hps, metric, metric_per_pipeline, time_per_pipeline = metadataset.evaluate_ensembles([[0], [1], [2]])
    ...
    pipeline_hps, metric, metric_per_pipeline, time_per_pipeline = metadataset.evaluate_ensembles([[0]])
