...
try:
    import RegularizedNeuralEnsemblers.metadatasets.scikit_learn.metadataset as slmd
except Exception as e:
    print(e)
    slmd = None
try:
    import RegularizedNeuralEnsemblers.metadatasets.tabrepo.metadataset as trmd
except:
    trmd = None
import RegularizedNeuralEnsemblers.metadatasets.nasbench201.metadataset as nbmd
