...
PIPELINE_BENCH_DIR="RegularizedNeuralEnsemblers/metadatasets/scikit_learn/pipeline_bench"
AUTO_SKLEARN_PATH="RegularizedNeuralEnsemblers/metadatasets/scikit_learn/pipeline_bench/pipeline_bench/auto-sklearn"
