...
Usage:
    python -m RegularizedNeuralEnsemblers.plot [OPTIONS]

    For detailed options, run `python -m RegularizedNeuralEnsemblers.plot --help`
...
parser = argparse.ArgumentParser(
    prog="python -m RegularizedNeuralEnsemblers.plot",
...
parser.add_argument("--project_name", default="RegularizedNeuralEnsemblers", help="Wandb project name.")
...
# python -m RegularizedNeuralEnsemblers.plot --user_name relea-research --project_name RegularizedNeuralEnsemblers --group_names "G1" "G2" "G3" "G4" --plot_type regret
