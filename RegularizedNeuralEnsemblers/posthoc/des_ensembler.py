...
METHOD_TO_CLASS = {"KNORAE": KNORAE, "MetaDES": METADES, "KNOP": KNOP}
...
class DESEnsembler(BaseEnsembler):
    def __init__(
        ...
        **kwargs,
        ...
        assert hasattr(self.metadataset, "get_base_pipelines") and hasattr(
    ...
    def sample(
        ...
        **kwargs,
        ...
        self.metadataset.set_state(
            dataset_name=self.metadataset.dataset_name, split="valid"
        )
