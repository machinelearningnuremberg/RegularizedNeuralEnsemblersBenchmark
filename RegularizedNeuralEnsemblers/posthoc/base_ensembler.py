...
class BaseEnsembler:
    ...
    def __init__(
        ...
        self.set_state(metadataset=metadataset, device=device)
    ...
    def evaluate_on_split(
        ...
        if weights is None:
            _, metric, metric_per_pipeline, _ = self.metadataset.evaluate_ensembles(
                [self.best_ensemble]
            )
        else:
            (
                ...
                metric_per_pipeline,
                _,
            ) = self.metadataset.evaluate_ensembles_with_weights(
