...
import RegularizedNeuralEnsemblers as RNE
from RegularizedNeuralEnsemblers_experiments.utils.util import get_config, set_seed
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ne_reg_term_norm", type=float, default=0.0)
    parser.add_argument("--ne_context_size", type=int, default=32)
    parser.add_argument("--ne_eval_context_size", type=int, default=256)
    parser.add_argument("--ne_reg_term_div", type=float, default=0.0)
    ...
    parser.add_argument("--ne_dropout_rate", type=float, default=0.0)
    parser.add_argument("--ne_net_type", type=str, default="ffn")
    parser.add_argument("--ne_auto_dropout", action="store_true")
    parser.add_argument("--ne_weight_thd", type=float, default=0.0)
    ...
    parser.add_argument("--ne_pct_valid_data", type=float, default=1.0)
    ##################### OTHERS #####################################################
    ...
    parser.add_argument("--pct_valid_data", type=float, default=1.0)
    ...
    parser.add_argument("--project_name", type=str, default="RegularizedNeuralEnsemblers")
    ...
    config = get_config(args, function=RNE.run)
