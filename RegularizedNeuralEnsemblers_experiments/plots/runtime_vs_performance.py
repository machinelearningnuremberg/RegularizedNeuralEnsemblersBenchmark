...
merged_df = pd.merge(
    runtimes, processed_table.to_frame(), left_index=True, right_index=True
)
...
plt.savefig(
    "SearchingOptimalEnsembles_experiments/plots/saved_plots/runtime_vs_performance.png",
    bbox_inches="tight",
)
plt.savefig(
    "SearchingOptimalEnsembles_experiments/plots/saved_plots/runtime_vs_performance.pdf",
    bbox_inches="tight",
)
