...
path = "RegularizedNeuralEnsemblers_experiments/reports/report37/"
...
dict_names_methods = {"neural": "NE-Stack", "greedy": "Greedy"}
        ...
        for method in methods:
            if method in value:
                results[method].append(
                    np.nanmean(processed_table.loc[value, selected_columns].values)
                )
...
plt.tight_layout()
plt.savefig(
    "RegularizedNeuralEnsemblers_experiments/plots/saved_plots/comparison_validation_size.png",
    bbox_inches="tight",
)
plt.savefig(
    "RegularizedNeuralEnsemblers_experiments/plots/saved_plots/comparison_validation_size.pdf",
    bbox_inches="tight",
)
